...
// ── ROUTE: AI proxy (Sila agent) ────────────────────────────
app.post('/api/chat', aiLimiter, async (req, res) => {
  const apiKey = process.env.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;
  if (!apiKey) {
